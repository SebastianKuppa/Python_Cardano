...
def add_funds_to_gift_contract(gift_script_address, giver_address, giver_skey, taker_vkey):
...
if __name__ == "__main__":
    ...
    add_funds_to_gift_contract(gift_script_address, giver_address, giver_skey, taker_vkey)
    # retrieve funds from gift script
    taker_takes_gift(gift_script, taker_address)
